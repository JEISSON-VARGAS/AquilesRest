...
import com.api.aquilesApi.Business.TeamScrumBusiness;
...
public class TeamScrumController {

    @Autowired
    private TeamScrumBusiness teamsScrumBusiness;
    ...
    public ResponseEntity<Map<String , Object>> findAll(@RequestParam(defaultValue = "0") int page,
        ...
        try {
            Page<TeamScrumDTO> teamsScrumDtoPage = teamsScrumBusiness.findAll(page, size);
    ...
    public ResponseEntity<Map<String , Object>> findById(@PathVariable Long id){
        try {
            TeamScrumDTO teamsScrumDto = this.teamsScrumBusiness.findById(id);
