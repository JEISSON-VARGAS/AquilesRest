...
import com.api.aquilesApi.Service.TrainerService;
...
public class TrainerBusiness {
    ...
    public Page<TrainersDto> findAll (int page , int size){
        try {
            ...
            Page<Trainer> trainersEntityPage = trainersService.findAll(pageRequest);
    ...
    public TrainersDto findById(Long id){
        try {
            Trainer trainers = trainersService.getById(id);
            // Configurar El Mapeo Manualmente si es necesario
            modelMapper.typeMap(Trainer.class , TrainersDto.class)
                    .addMapping(Trainer::getTrainerId , TrainersDto::setTrainerId);
    ...
    public void add (Map<String , Object> json){
        try {
            ...
            Trainer trainersEntity = modelMapper.map(trainersDto , Trainer.class);
    ...
    public void update(Long trainerId , Map<String , Object> json){
        try {
            ...
            var trainer = modelMapper.map(this.validationObject(json , trainerDto) , Trainer.class);
    ...
    public void delete(Long trainerId){
        try {
            Trainer trainers = trainersService.getById(trainerId);
